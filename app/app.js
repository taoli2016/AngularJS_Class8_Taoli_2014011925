...
.controller("mainctrl",function($scope){
	...
	$scope.tmp=true;
	$scope.userName="举个栗子";
	$scope.displaySrc="images/t1.jpg";
	$scope.fansNum=250;
	...
	$scope.addFans=function()
	{
		if($scope.tmp==true)
		{
		    ...
		    document.getElementById("addFans").value="不再支持！";
		    $scope.tmp=false;
		}
		else
		{
			$scope.fansNum=$scope.fansNum-1;
		    document.getElementById("addFans").value="支持他！";
		    $scope.tmp=true;
		}
	...
	$scope.sendMsg=function()
	{
		...
		newItem.innerHTML="<div class='m-l-lg'><a class='pull-left thumb-sm avatar'><img src='"+src+"'></a><div class='m-l-xxl panel b-a'><div class='panel-heading pos-rlt'><span class='arrow left pull-up'></span><span class='text-muted m-l-sm pull-right'></span><a href=''>"+username+"：</a>"+msg+"</div></div></div>";
